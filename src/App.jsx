                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="bg-white rounded-xl shadow-md relative">
                            <div className="p-4">
                                ...
                                <div className="mb-5">
                                    Join our team as a Front-End Developer in
                                    sunny Miami, FL. We are looking for a
                        ...
                        <div className="bg-white rounded-xl shadow-md relative">
                            <div className="p-4">
                                ...
                                <div className="mb-5">
                                    Are you passionate about front-end
                                    development? Join our team in vibrant
                                    Brooklyn, NY, and work on exciting projects
